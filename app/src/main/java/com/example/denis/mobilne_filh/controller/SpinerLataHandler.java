...
public class SpinerLataHandler implements AdapterView.OnItemSelectedListener {


    MainActivity activity;

    public SpinerLataHandler(MainActivity activity) {
    ...
    public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
        ...
        String wartosc = activity.getSpinner_lata().getItemAtPosition(position).toString().trim();
        double wartosc2 = Double.parseDouble(wartosc);
